...
$result = mysqli_query($mysqli, "select * from lapangan");
session_start();
?>
...
<body>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="../lapangan/index.php"><span style="font-weight: bold;">Lapangan</span></a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="col-12" style="margin-top: 50px;">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Data Lapangan
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        foreach ($result as $data) {
                            ...
                            <td>
                            <a href="edit.php?kode_lapangan=' . $data['kode_lapangan'] . '" class="btn btn-warning">Update</a>
                            <a style="margin-left:10px" href="#" onclick="deleteData(' . "'$data[kode_lapangan]'" . ')" class="btn btn-danger">Delete</td>
                            </tr>
                            ';
                        }
                        ?>
                ...
                <div class="modal-body">
                    <form action="add.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="kode_lapangan" required="true">
                        </div>
                        <div class="form-group">
                            <label for="">Nama Lapangan</label>
                            <input type="text" class="form-control" name="nama_lapangan" required="true">
                        </div>
                </div>
    ...
    <script language="JavaScript" type="text/javascript">
        function deleteData(id) {
            if (confirm("Are you sure you want to delete this data?")) {
                window.location.href = 'delete.php?kode_lapangan=' + id;
            }
        }
    </script>
</body>
